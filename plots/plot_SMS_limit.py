...
if options.signal == 'T2tt':
    ...
    lexp_0l.SetPoint(0, Xmin+3*xRange/100, Ymax-3.00*yRange/100*10)
    lexp_0l.SetPoint(1, Xmin+10*xRange/100, Ymax-3.00*yRange/100*10)
    lexp_0l.Draw("same")
    textExp_0l = ROOT.TLatex(Xmin+11*xRange/100, Ymax-3.15*yRange/100*10, "Expected 0l")
    ...
    lexp_1l.SetPoint(0, Xmin+3*xRange/100, Ymax-3.60*yRange/100*10)
    lexp_1l.SetPoint(1, Xmin+10*xRange/100, Ymax-3.60*yRange/100*10)
    lexp_1l.Draw("same")
    textExp_1l = ROOT.TLatex(Xmin+11*xRange/100, Ymax-3.75*yRange/100*10, "Expected 1l")
    ...
    lexp_2l.SetPoint(0, Xmin+53*xRange/100, Ymax-3.00*yRange/100*10)
    lexp_2l.SetPoint(1, Xmin+60*xRange/100, Ymax-3.00*yRange/100*10)
    lexp_2l.Draw("same")
    textExp_2l = ROOT.TLatex(Xmin+61*xRange/100, Ymax-3.15*yRange/100*10, "Expected 2l")
    textExp_2l.SetTextFont(42)
    textExp_2l.SetTextSize(0.035)
    textExp_2l.Draw()
    
    ## Corridor results
    exp_corr = ROOT.TGraph()
    exp_corr.SetPoint(1, 145, 0)
    exp_corr.SetPoint(2, 265, 120)
    exp_corr.SetPoint(3, 295, 90)
    exp_corr.SetPoint(4, 205, 0)
    exp_corr.SetLineWidth(4)
    exp_corr.SetLineStyle(8)
    exp_corr.SetLineColor(ROOT.kCyan+1)
    exp_corr.Draw("same")

    lexp_corr = ROOT.TGraph(2)
    lexp_corr.SetName("LExp2l")
    lexp_corr.SetTitle("LExp2l")
    lexp_corr.SetLineColor(ROOT.kCyan+1)
    lexp_corr.SetLineStyle(8)
    lexp_corr.SetLineWidth(4)
    lexp_corr.SetPoint(0, Xmin+53*xRange/100, Ymax-3.60*yRange/100*10)
    lexp_corr.SetPoint(1, Xmin+60*xRange/100, Ymax-3.60*yRange/100*10)
    lexp_corr.Draw("same")
    textExp_corr = ROOT.TLatex(Xmin+61*xRange/100, Ymax-3.75*yRange/100*10, "Expected corridor")
    textExp_corr.SetTextFont(42)
    textExp_corr.SetTextSize(0.035)
    textExp_corr.Draw()
